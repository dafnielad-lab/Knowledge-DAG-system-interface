...
נסמן $Q(n) = 1^2 + 2^2 + \cdots + n^2$ ונוכיח באינדוקציה (לפי ax_principle_of_mathematical_induction) שעבור $n \geq 1$ מתקיים $Q(n) = \frac{n(n+1)(2n+1)}{6}$.
...
פירוק הריבועית: $2n^2 + 7n + 6 = (n+2)(2n+3)$ (בדיקה ישירה לפי ax_distributive_law ו-ax_addition_commutativity: $(n+2)(2n+3) = 2n^2 + 3n + 4n + 6 = 2n^2 + 7n + 6$). לכן:
$$Q(n+1) = \frac{(n+1)(n+2)(2n+3)}{6} = \frac{(n+1)\bigl((n+1)+1\bigr)\bigl(2(n+1)+1\bigr)}{6},$$
וזו בדיוק הזהות עבור $n+1$. לפי ax_principle_of_mathematical_induction, הזהות תקפה לכל $n \geq 1$. $\blacksquare$
