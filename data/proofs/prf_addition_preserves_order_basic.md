...
לפי האקסיומה ax_addition_preserves_order (שימור סדר בחיבור): אם $a < b$, אז $a + c < b + c$ לכל $c \in \mathbb{R}$. ההנחה $a < b$ מתקיימת, ו-$c \in \mathbb{R}$ נתון. לכן המסקנה תופסת ישירות: $a + c < b + c$.
